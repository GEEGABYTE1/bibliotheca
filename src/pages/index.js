...
export default function Home() {
  ...
  backgroundRepeat="no-repeat">
      ...
      <Link href="/signin"><Center><Button _hover={{ bg:"#f4a261" }} border='2px' padding="5px" marginTop="5em" boxShadow= '2xl'width='600px' rounded='md' size='lg' bg='white'> Get Started!</Button></Center></Link>
